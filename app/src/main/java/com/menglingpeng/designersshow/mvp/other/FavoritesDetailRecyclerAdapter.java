...
public class FavoritesDetailRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if(holder instanceof FavoritesRecyclerAdapter.BookViewHolder){
            final FavoritesRecyclerAdapter.BookViewHolder viewHolder = (FavoritesRecyclerAdapter.BookViewHolder)holder;
